        ...
        <div className="container-custom max-w-5xl">
          <div className="bg-white rounded-3xl shadow-sm overflow-hidden mb-8">
            <div className="grid grid-cols-1 md:grid-cols-3 md:gap-x-8">
              {/* Left Column: Text Content + Product Card */}
              <div className="md:col-span-2 flex flex-col">
                ...
                {/* Product Card Section - Placed below text content in the left column */}
                <div className="p-6 md:p-8 bg-[#FAFAFA] mt-8 md:mt-12">
                  <div className="w-full max-w-sm mx-auto mb-6">
                    <div className="relative">
                      <div className="bg-[#F9E5FF] rounded-xl p-4 mb-4 text-center">
                        ...
                        <p className="text-[#5D4777] font-medium uppercase text-sm tracking-wide">1 Month Subscription</p> {/* Corrected ffont-medium */} 
                      </div>
                      <img 
                        src="/telegram.png" 
              ...
              <div className="md:col-span-1">
                <div className="p-6 md:p-8 md:sticky md:top-28"> {/* Added sticky positioning for video on scroll */} 
