                ...
                <div className="w-full max-w-sm mx-auto mb-6">
                  <div className="relative">
                    <div className="bg-[#F9E5FF] rounded-xl p-4 mb-4 text-center">
                      ...
                      <p className="text-[#5D4777] ffont-medium uppercase text-sm tracking-wide">1 Month Subscription</p>
                    </div>
                    <img 
                      src="/telegram.png" 
  ...
  <p className="text-[#5D4777] font-medium uppercase text-sm tracking-wide">
    1 Month Subscription
              ...
              <div style={{paddingTop:'56.25%',position:'relative'}}>
                <iframe src="https://app.tpstreams.com/embed/6u448b/7f2CDfh8sRJ/?access_token=2ba9a940-67be-4207-a0a6-73a130ac6228" style={{border:0,maxWidth:'100%',position:'absolute',top:0,left:0,height:'100%',width:'100%'}} allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen={true} frameBorder="0" />
              </div>
